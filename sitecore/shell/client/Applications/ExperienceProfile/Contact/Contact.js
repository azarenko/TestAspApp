define(["sitecore", "/-/speak/v1/experienceprofile/DataProviderHelper.js", "/-/speak/v1/experienceprofile/CintelUtl.js"], function (sc, providerHelper, cintelUtil) {
    ...
    var app = sc.Definitions.App.extend({
        ...
        anonymize: function () {
            var anonymizeUrl = sc.Contact.baseUrl.replace("/contacts/", "/contacts/anonymize/");
            providerHelper.initProvider(this.ContactDetailsDataProvider, "", anonymizeUrl, mainApp.ContactTabMessageBar);
            providerHelper.anonymize(
