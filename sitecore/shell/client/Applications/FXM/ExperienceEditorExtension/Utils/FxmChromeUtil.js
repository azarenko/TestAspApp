...
"/-/speak/v1/ExperienceEditor/ExperienceEditor.js"
  ...
  return {
    openEditClientActionPropertiesDialog: function (chrome) {
      ...
      var dialogPath = "/sitecore/client/Applications/FXM/ExperienceEditorExtension/Dialogs/CaptureClientAction/?id=" + encodeURIComponent(id) + "&lang=" + encodeURIComponent(experienceEditor.generateDefaultContext().currentContext.language);
