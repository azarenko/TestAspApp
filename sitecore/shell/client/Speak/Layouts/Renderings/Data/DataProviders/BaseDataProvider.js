define(["sitecore"], function (_sc) { 
  _sc.Factories.createBaseComponent({
    ...
    performPostRequest: function (serverRequestUrl, providerItemProperties, serverRequestParameters, serverRequestOnSuccess, requestData) {
        "use strict";
        ...
        var ajaxOptions = {
            ...
            headers: {},
            data: requestData,
            url: serverRequestUrl + this.getRequestDataString(providerItemProperties, serverRequestParameters, this.model.get("queryParameters")),
            success: function (data) {
                self.baseSuccessHandler(data, serverRequestOnSuccess);
            },
            error: function (response) {
