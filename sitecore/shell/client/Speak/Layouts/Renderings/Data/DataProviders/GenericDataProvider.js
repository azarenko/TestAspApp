...
define(["sitecore", "baseDataprovider"], function (_sc) {
  _sc.Factories.createBaseComponent({
    ...
    postData: function (serverRequestOptions, requestData) {
        "use strict";
        ...
        this.performPostRequest(serverRequestUrl, providerItemProperties, serverRequestParameters, serverRequestOnSuccess, requestData);
    },
