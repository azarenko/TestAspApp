			...
			function updateProgress() {
				$.ajax({
					...
					success: function (msg) {
						...
						var reportPath = msg.d.PackagePath;
						...
						if (percentage !== 100) {
							...
							if (currentStatus === "Generating failed.") {
								$("#updatingText").text(currentStatus);
...
<body style="font-family: Segoe UI, Tahoma Arial, Helvetica, sans-serif;">
	<form id="form1" runat="server" class="wf-container">
		...
		<div class="wf-content">
			...
			<h1 runat="server" id="Header">Sitecore Support Package Generator</h1>
			...
			<div id="MetadataContainer" runat="server" style="margin-top: 15px;" visible="True">
				...
				<div style="clear: both;">
					...
					<span style="float: right">
						<asp:TextBox runat="server" Width="373" ID="PackageNameTextbox" /></span>
				</div>
				<div style="clear: both; margin: -15px 0">
					<span style="float: left; margin-top: 9px">
						<label>Support ticket ID (optional):</label></span>
					<span style="float: right; margin-top: 9px">
						<asp:TextBox runat="server" Width="373" ID="IdTextbox" /></span>
				</div>
				<div style="clear: both;">
					<span style="float: left; margin-top: 9px">
					...
					<span style="float: right; margin-top: 9px">
						<input type="text" id="startDate" runat="server" readonly="readonly" style="width: 148px;" />
						<label style="margin-right: 5px; margin-left: 15px">End date:</label><input type="text" id="endDate" runat="server" readonly="readonly" style="width: 148px;" />
					</span>
				</div>
				<div style="clear: both;">
					<span style="float: left; margin-top: 9px; margin-bottom: 15px">
						<label>Comments (optional):</label></span>
					<span style="float: right; margin-top: 9px">
						<asp:TextBox runat="server" Width="373" ID="CommnetsTextbox" /></span>
				</div>
			</div>
		...
		<div class="wf-footer" style="margin-top: 15px; clear: both;">
			...
			<asp:Button runat="server" ID="RestartButton" OnClick="RestartButtonClick" Text="Restart" Visible="False" />
			<asp:Button runat="server" ID="NextButton" OnClick="NextButtonClick" Text="Next" />
