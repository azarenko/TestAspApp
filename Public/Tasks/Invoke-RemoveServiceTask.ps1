...
function Invoke-RemoveServiceTask {
    ...
    $instance = Get-CimInstance -Class win32_service -Filter "Name = '$Name'"
    if($instance){
        if($PSCmdlet.ShouldProcess($Name, 'Deleting service')) {
            Write-Verbose "Removing Service '$Name'"
            Remove-CimInstance -InputObject $instance
            Write-TaskInfo -Message $Name -Tag 'Removed'
        }
    } else {
        Write-Warning -Message "Could not find service: '$Name'"
    }
}
# SIG # Begin signature block
# MIIXwQYJKoZIhvcNAQcCoIIXsjCCF64CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwM/M2eFDBrpmdAD4k5CxrfCh
# q96gghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGgwDLJSGdAo3nZPEDqZ3l9g
# oh6tMA0GCSqGSIb3DQEBAQUABIIBAK/AKckcw3gIsq/XhFaxqSVxOoIo936MKeZ1
# SyQ3PIMz5t3dECA7ThalvXuo3xjJKzimdQsEowYy9mRF/2DV8j3E3wGyDmq43pLY
# c9+kO4JQ4EPqK3kxoLfBoqfW0MdiGZTc7tlRYYl0SCwIz3EZf+VLMSTmYIvTL+27
# /IMlO28oDDesK8927v9JCpGvH8zacgkB7KUb/Wn6U24LtpMXSv9wFKk7l7+cZndb
# DH68Qtr+EysSUBtiyCwTn/jheqwCv4fGU2aOLf0KNdA6Gd+7R0n5a37ZAS1ZVnys
# Q7zqH5344ZAHr5KMIWAukEl1gu3ik8xJh/lO2lMIPkaYwkYqWYWhggILMIICBwYJ
...
# MTgwMjEyMDgzMzUzWjAjBgkqhkiG9w0BCQQxFgQUqHhGswWAEVo2sLvxeVJSDMkc
# D+UwDQYJKoZIhvcNAQEBBQAEggEAanf9BewEbmLmFdTtyDCj/uHOOYJw3oQhB/b1
# svYGiD5nNkj1KHwqiV5tGCJoDNjnIaOJ8cCMf83ADN/z9oujCN55l1jrnAojySP+
# Umoax1i+zdul1PJA6hRDCI9jolp4RgqDm3HYWx7PJayi3S6VNlthA0JfVJxd3Q2l
# xz9Ib0uJpL60gupemV4T4dazRtPrR/GJgMxDUQ4lhNj+RPVS/K1qJSPC7iJPEN9V
# vbt9LtnXZXeDYa45l7sEWo1B8u9G2V+dJ4OkSWRqRI4XOQvwvmCtGAkijaHm8kfa
# yhHqslhsTqrQxFe8bmQ88jWHGspuEwvqfj59YMyLlVNIWTiv/g==
