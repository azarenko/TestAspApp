...
function Invoke-ManageSolrCoreTask {
    [CmdletBinding(SupportsShouldProcess=$true)]
    param(
        [Parameter(Mandatory=$true)]
		[ValidateSet('create', 'unload')]
		[string]$Action,
        [Parameter(Mandatory=$true)]
        [string]$Address,
	...
	try {
		...
		$uri = "$Address/admin/cores?action=$Action&$uriParameters&wt=json"

		try {
			if($PSCmdlet.ShouldProcess($Address, "Invoke-ManageSolrCoreTask -Address $Address -Action $Action")) {
				Write-TaskInfo -Message ("Performing $Action on $Address" | Out-String) -Tag 'SolrCore'

				Write-Verbose "Updating Solr: Uri => '$uri'"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUl1eMKQVIAA/tpZ67Ojp05vO9
# cEagghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJbt5Lr1lubqyoJNd88v+/IG
# 1dE1MA0GCSqGSIb3DQEBAQUABIIBAK4wXoN/FrfFN+lXyRr6DJ7G6bubgAvFBJFf
# wHSUa3JPOsh6njm3pTsLLCkLd77+W7ZQ8p3QsqrMUmVABN24q6gzWPUo74MiHDQe
# NxkSXtDXIMgKNe+pnkgGWC8+2ANIbYB6B9F4C7eU6i0sQRU4Vvu3yzakTsdUt2BY
# RGibMOk/Op/TEM2m8ZiQBidVuMy1gcDEWj9XNmHrQuljIIX3ymRNjjxj4CCuLjjb
# EYQWrYLBdwWAOergK0fRMpSespJE9wo1zz7dzItTwoMYgT7VO3x+AbUc6xK7Hitq
# hbAVJOrS7TYE/PKRTlBlhVNZEvedpUE96ou+fA2Ly6hJYutVFW6hggILMIICBwYJ
...
# MTgwMjEyMDgzNDAzWjAjBgkqhkiG9w0BCQQxFgQUMKLaFsiM9OGehaJc2kt6mNoM
# v7YwDQYJKoZIhvcNAQEBBQAEggEAeaG0jJsRIAUmqH0vZ6I7MCPbFbOLqxJTCJHY
# K1wXmF7mBcKLWGy6e4/1v1HKuejJLykwyS1DnGbvSiVbIF/X9L+pzSivYLhNyAAK
# 4a1i9Am1YnHn5/Lhkcm0BtI5mBtnjQkJvA1DP77nyhbAQeFeObeZgGGpEe0o34d3
# wWVTS/S/aol/PiWiurhE1ycTk8HnKwW0E8Js6HhtZ4OpZcgdewVKbUCpnBxdkrX6
# oe66FoVcr/9oTQ/s6eooPB770oyHCdpNPSRodHhmyFfYZ5B6S0cLJzRRU9pvXVpA
# i9Q7QpfxolcTkW12fS41yIpaVWnbFx+G1R/k/mzgf7naDqzfYg==
