...
function Invoke-WebRequestTask {
    ...
    $RequestTimeoutSec = $RequestTimeout / 1000

    if($PSCmdlet.ShouldProcess($Uri, "Requesting")) {
        $requestCount = 0

        while($requestCount -lt $RetryCount){
            $requestCount++
            try {
                Write-TaskInfo -Message $uri -Tag "Requesting"
                ...
                Write-Warning "[$($requestCount)/$RetryCount] Request Failed: $_"

                if($requestCount -lt $RetryCount){
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUHwBhZU0pnAT0c0Sir8q6qXYr
# LxqgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIbh6rV/GLkU1zDe4aqQJA0h
# b8GrMA0GCSqGSIb3DQEBAQUABIIBAGtdxEh2Ouook2tkBa+thgfsGpcpqqFefK2l
# u7LtKG/wOgq5ImULB5lOQFV8rmUQQNJ4+SWU2ege4RtCLuN5nSdUquB6vbJBgO8i
# OuCeltFAxK7A0TW17V5ntQ9syRJqmRH9oxO9vFH9Jz+5ezuUXnCFCQ4GaS9eloCs
# lhX3LPVPteoY3qlGHyNw48Ens2cdJvYHL1gIlawHt5P/XikrkHyAbw2fFgaE54cu
# gd3UWc/JmKj1Hh1ITJ9vptiy4HZVMhhzbC4nK9cXx3ajV6NLZIOd9DLyd74MhNqf
# TAW3GBE881Wfj7hbIpGxNZDaOMtxdCctJhV9wKhf8d4yW273iGKhggILMIICBwYJ
...
# MTgwMjEyMDgzMzU3WjAjBgkqhkiG9w0BCQQxFgQUsHrJdxdEiMC670UbmHyHe5Fq
# uGIwDQYJKoZIhvcNAQEBBQAEggEAZWXP+digJx8LQyAM4i0QmpvpJAL0vjYn71MQ
# yUIxdTaaoPEev7IHN5sxsJcsIbXwiJuNHuTgJdXHqoJcZQhKeEHt0szddDgQrxZf
# MjAviy507PURYcFEpZXXceTh7rdyAh9Mu+5vGKjgP9AlgvpJAVPg2e7IX/7Nrt/c
# o0pNFoTEjR7THWbC+AJYWllaZP7h1eOjAI7XKUvis6uwI6PHc8kqx/M9aaVsKKUr
# kVdf+RBP9e6xRnzoVUv8LpuL8PZLizCksu5NtpLJWjFmAoqRCafUQE70kcu5UJd7
# niunG+ZLp7HUK1mFaXpJW8qPzkyXKJilwNdL0q3zoWzL4i9fcw==
