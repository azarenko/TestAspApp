...
Function Invoke-SitecoreUrlTask {
    ...
    if($PSCmdlet.ShouldProcess("$actionPage", "Invoke-SitecoreUrlTask")) {
        ...
        function GetAuthorizedSession {
            ...
            Write-TaskInfo -Message $actionPage -Tag "Authenticating"
            $uri = "$SitecoreInstanceRoot/sitecore/login"
        ...
        function TestCookie {
            ...
            $discovered = @($cookies.GetCookies($SitecoreInstanceRoot) |
                Where-Object { $_.Name -eq '.ASPXAUTH' })
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0CXmsMC3NRG0rN4RJhFdLI+G
# r7mgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEYAkH+kEapVnYfz4g/YIOxh
# GkX+MA0GCSqGSIb3DQEBAQUABIIBAD+XZ1lM4X71Bhk3Fqne0vPl8l0l2FGf36Pw
# QkJcWOILdq8NUGCYMdcTQ5Ou9+orcPrCU5jgc4/+jcOp+ihiaAxQqstwtzAFKJ/n
# Ngkzi8tqATvW7cHRb40Oq+CfvwPwBFShs5C1RlEMAY81sGe8xNPaf7IoSselL3jh
# Lr/5/DISvMxWJEIf/ay05xTBBC+wB35bAvZrxcH4oY3fH0ArnJzD5A9u4/eiEeGt
# Qp4gYyy5XkE1kP8/7SFaH27Y032gx9dwmgSmraugl6+fdGC/qYXcDnHCWTKXiaEI
# b5UySaziotVjxg0XEAUymCWVymQpqGhdY4UTj45bluMjF8Ryh9ehggILMIICBwYJ
...
# MTgwMjEyMDgzNDA0WjAjBgkqhkiG9w0BCQQxFgQUq/GssBwAeQjNudXscKnqwCSG
# ihUwDQYJKoZIhvcNAQEBBQAEggEAdjlGBJ3XLKrIBZRMeWK+gXjA3Hp290eg2wus
# /aun6FIrwcI+itrRZydu95eG6fR589KLmeMloLsdWHgB0C0xrdWx93vkYrxTFvcA
# eQd079tbgrV3wZ85rbvD18w2hy4jlDc884E+MeoWBc/foIr2OvJOy09BuDV77r6k
# 3jMpKXpOHJ3OvoBMrGylSyMdvwxSGwlJ8e+kZeCM7fj8l925mUJSwKAT5x5pu2nv
# s+zZdC83XJeMzPx/aa5OJYhwOsf0swAfoh8Rso4QS+y9s05Cmig2XWVeiYaJJjm4
# SLJd7T9lUAANHExcG/BghX2v1BcdiPETkSq8oZiH3w4U8pPRbg==
