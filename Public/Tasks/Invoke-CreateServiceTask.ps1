...
function Invoke-CreateServiceTask {
    ...
    if($Arguments.Length -gt 0) {
        $composedPath += ' '
        $composedPath += $Arguments -join ' '
    }

    Write-Verbose "Service path: $composedPath"

    $params = @{
        Name = $Name
        BinaryPathName = $composedPath
    }
    ...
    foreach($key in $params.Keys){
        Write-Verbose "Service setting: $key = $($params.$Key)"
        Write-TaskInfo -Message "$key => $($params.$Key)" -Tag 'Setting'
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvkThuFgyg04Gxr/AAH5/Egdy
# lzWgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFN90VbjCkB0G3go71IDeKYTM
# DSyOMA0GCSqGSIb3DQEBAQUABIIBAI+8QBp7TenUrvJsnx+VFtyydUf926u0vSj2
# 6QIdwxofqM14pf2SXXLwFU4JaF9QEew/Z4gC7njpbSBlv9FYCMOEFcX3AraIQaZw
# E1lcFKhCeNQPsPqjqYbFhCjzeApKT6CDpU6GcZaZ5V7a5Fj89rsrUuJ+RMMax7aR
# Bd4Kde7CmmiiJCx+F+6DBdk1nsQtkJlqoEZQoJhIzIQQknm4Sqj0Q2ZyOxUth3IN
# dj8D1WJMGFSZJGKw+60flbFQqdfDO2dMPQurQOoDuyT7w01+sJPi8k8RFIdr7Tcd
# FUEVbWgZ6rRfUfHXp4fdztwS1jfK4sCEMEthsOccyfehGEB4qI+hggILMIICBwYJ
...
# MTgwMjEyMDgzMzU0WjAjBgkqhkiG9w0BCQQxFgQUad4w2/jLPYvPsoRbujecwPmo
# z6wwDQYJKoZIhvcNAQEBBQAEggEAicwk8CntRDRXCAaF8LZXeXCeqSuFOrAf8l8u
# HraIWtrwPB1lZxhYkz8pps1BeLsu0MRqOgQareVdXivYhjl/eRSH3JFXRHobTXw/
# 2YwKMRlYj5fmvmGwMVCFDktcC5cJxg/wt3pKZS4NQBHBM9+/5iigJbI4En+6A1+D
# hMBUmpctMoBM9hc+jKYYAIQdebLYAUIeiTs4eGGWRaKr4soPNiwXUkp7fT3pSla0
# 01v+e5DvUMMQO48qU+vde4bWRyt+PPhq2H6GGIQxOEWKXmRrrQAjqQlnkiwaZhgD
# 80g0jMaL5fIMIA+t0pzt7PEq5wylEWODXFuXoe+E6pbqHxaduw==
