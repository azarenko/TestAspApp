...
Function Invoke-WebsiteClientCertTask {
    [CmdletBinding(SupportsShouldProcess=$true)]
    param(
        [Parameter(Mandatory=$true)]
        [string]$SiteName,
        [Parameter(Mandatory=$true)]
        [ValidateSet('Ignore','Accept','Require')]
        [string]$Setting,
        [switch]$Ssl
    )
    ...
    try {
        ...
        switch($Setting) {
            'Accept' {
                Write-Verbose "Setting: SslNegotiateCert"
                $value += 'SslNegotiateCert'
            }
            'Require' {
                Write-Verbose "Setting: SslRequireCert"
                $ssl = $true
        ...
        if($Ssl) {
            Write-Verbose "Setting: Ssl"
            $value += 'Ssl'
        }

        $params = @{
            SiteName = $SiteName
            ConfigPath = 'system.webServer/security/access'
            Key = 'sslFlags'
            Value = ($value -join ',')
        }

        if($PSCmdlet.ShouldProcess($SiteName, "Setting SSLFlags: $($params.Value)")) {
            Invoke-IISConfigurationTask @params
        }
    } catch {
        Write-Error $_
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhH7pcdMVzEb/L1W1I2rTySQ7
# sjigghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHoLRZcqfPFdVqJNR4/QIVxM
# 3vJMMA0GCSqGSIb3DQEBAQUABIIBADFVv1IBAo+DOBbfma5uVSoAGIWT9oU5WiRi
# /vjp4LEY1WeAf7czWmA1hnu6LowjwYgcX8l/PYSrEbj/cO0ZbGLmN3wRgSNP04Xw
# xXZ0PW4QaoEbtyBtLVEzPBXXsoHjl+EN+00VrcilO+DBLSdepXMntkAj0QkYOkuE
# LO1Gx01vGt6ZmiN5bM0HOLncr3TP8lHz822qaUD5tKnDfAscHx4ainGBVQOBRNzj
# myoOqv2kXovLSBFXxwi97ZhyNxCyCCC2xM0STH3cp+kV2A1e57pp1wHKXiy70Ee5
# HHeD0Ow3iyMDVtK3A7c/BNI36tEkDmEhiTXdfHStJc/QH5zL3LShggILMIICBwYJ
...
# MTgwMjEyMDgzMzUxWjAjBgkqhkiG9w0BCQQxFgQUIgBoJspN9C1B52vW8LqHb/y2
# bTQwDQYJKoZIhvcNAQEBBQAEggEAMoF8MTkThnGCgoi8WQ/EcKT44IlCEZEOlW+p
# Qaa4smOaDASrmZ4pcXB5wXFMHlAtU1AXhHC72TAQkGxbidEeozDQ4UfTps2YhKWL
# YW+JAolnFuhhUN1KLDuu71zFVsSJ3IbCMLtpcM9lolHtZrMOVDRPO5hPBi4jv9Wc
# 5290Rdlh6/00zsiMNv9kkBR9BSnQtwg8HerKdT4KSyVKAwaHl1jBUJgPGGeESG5N
# rKqvE8h1bK1UCLAO77uMydB4NdJUrRslkcyzONeS2DezA7EWi8v89qupREWdn9q3
# wn+C/VyK8z7gePg2nj0tysTbNcFdHJOjvEcf9Zov3cyPSC3yOw==
