...
function Invoke-WebBindingTask {
    ...
    try {
        ...
        foreach($entry in $Add){
            ...
            if(Get-WebBinding -Name $SiteName @entry){
                ...
                New-WebBinding -Name $SiteName @entry -SslFlags $sslFlags
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUpWMmOit/Wr5uX+jgkkuX8BhK
# 1bugghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFILzuJJUoN9k2LFhpe0sjaR/
# nQEmMA0GCSqGSIb3DQEBAQUABIIBAHtd7SbTDR13v/q1g+fO4w+uTg8bo2Y3FMgu
# nWjIV8yptIeY9PBZp+a5QlKsK1+tbHg4eqmwipglhwqi8lkN76QN3Dvm+imEbMLa
# zCnrgf+3P+yWCzJWSIsu13dy/nHmF/yO/N+qjQueLJdPCz5gUSj0Afs6zkAExe9I
# /Id7NCjShwYK1APy83A14ER2EKiP8XD8+BTZanXNwsEWYzTaXYTmpRLjJQJ2D5W8
# SElV2OwhyMGqyrmNqzM1sHE1xNHT+x+kfqxR0t6piOHRe/sLKLb7pr4Ayr/EfKG6
# uHvWWxtniYnpDwKrNgp1tM+mo04RMjIybJ8arON21m2IeT3oHkehggILMIICBwYJ
...
# MTgwMjEyMDgzMzUyWjAjBgkqhkiG9w0BCQQxFgQUeVW4pj5Ufiw63N/MJag4eoIq
# BkMwDQYJKoZIhvcNAQEBBQAEggEAL0FW3QGOvDEZc1324BCYIlwiVQcfpWGqHv8o
# 7pGabZR5abnsaRHgGptSK3acG1vwjb5bz4jWOf2hkqQRFVND+OViCBOVtErNHH8h
# mAQNj0AS7f7vnLB1F6qPgWZM4qUjGqtX3O3w3eRrTnwVXdhwhH2ecMwrDkI7kCtT
# LeZKFmKSPW+ImYm6owARC1qPvGIWChrtvOWCL3fUF2EiEq1p7ZOXbDC7qURLfnCt
# TrchtKy0eagieqMbk/y5hBr8KCgDYbIeFAcuF35UuYV7Lt6i8t9bfHfLcNP8RML1
# DHfjl1XGIPdWjRChOlhX+VPTy6/ZQiMxHhojWlEQAnJxLsFwZQ==
