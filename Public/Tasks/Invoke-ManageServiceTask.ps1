...
function Invoke-ManageServiceTask {
    ...
    Write-TaskInfo -Message $Name -Tag 'Updating'

    $params.Keys |
        Where-Object { $_ -ne 'Name' -and $_ -ne 'PassThru' } |
        ForEach-Object { Write-TaskInfo -Message "$_ => $($params.$_)" -Tag 'Setting' }

    if($PSCmdlet.ShouldProcess($Name, "Invoke-ManageServiceTask -Name $Name -Status $Status -StartupType $StartupType -Description $Description -DisplayName $DisplayName")) {
        $instance = Get-Service -Name $Name -ErrorAction SilentlyContinue
        if($instance) {
            ...
            switch($Status) {
                ...
                'Stopped' {
                    ...
                    $instance | Stop-Service -Force
                }
                'Paused' {
                    Write-Verbose "Suspending Service '$Name'"
                    $instance | Suspend-Service
                }
            }

            Write-Verbose "Setting properties for Service '$Name'"
            Set-Service @params
            if($PostDelay) {
            ...
            Write-Warning "Service '$Name' does not exist"
        }
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUaXpBiPey3x1qdPz3Id1OMuKD
# eP2gghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCYdMVu3tRSpS5/T31rXVwKZ
# dSaEMA0GCSqGSIb3DQEBAQUABIIBABEj8VTsjLDYChARCClYHPi+B3+A7+czUFod
# 4adg9MKm+omzJXp85zTgO/H0h8PC/iq7VKEps198IEA5s/lAfPvk44+DctO2Nf9e
# 9PNV0dIciMYQZzoo5RSnIs19MgDE17ykCqgwXxOHAVDHWzgMGM8hzFBde8AE72qr
# JMRCXUuM0ROT/z0UJw7nGyJnUhWy+YNobHyulTXdCY6J4j2bpgB77Q8OjLojjqEu
# xAzpj1jPr14R/16/BoNmFOqab6rqG+YGEhTrPKAwSCbi2E6PuoP9cQA4Tfzn85eR
# i9HPSyWTYTtMoRTrkeAiS7OhN/Ib8IelM6FNX+/0WGm16cTtLYKhggILMIICBwYJ
...
# MTgwMjEyMDgzMzUxWjAjBgkqhkiG9w0BCQQxFgQUKjCF3F+S2UTlorfsaMKW9kk0
# EugwDQYJKoZIhvcNAQEBBQAEggEAM+53cB8mbLQ8UJ9K8KxN89rpAdg7kWeFgUCZ
# OMaDjT0h64rQOpXqqsp95vf2hHHyijht2RVcV4fzw8opENZSEixJg6KfYTfUxyfc
# tjspv+TgwhXdgWvzcJBjB0+vV6WHQy9+TAaI7Vws4wKq8RysmGrkMNBhaG605L1V
# 7z6i7+C7E+IVvxAGUsBaV1yDHisjjwoYclXtjOZyXqvIgCJvQebk5Cjqwo1k29I3
# SS2GRDdY9VVwt8nTu0NAxa2SDGZxOn5P1PA8o3mF82BlJYIurEAG9OdDqA/OOBvV
# d4SggNMbPqORFDfx9nK8+FfyNGv3sfl+qHRvqY3z3nQgenCE0w==
