...
function Get-SitecoreInstallExtension {
    [CmdletBinding()]
    ...
    $extensions = ResolveExtension -All
    $results = $extensions.GetMemberNames() | ForEach-Object {
        $section = $_
        $extensions.$section.Keys | ForEach-Object {
            [pscustomobject]@{
                Name = $_
                Type = $section
                Command = $extensions.$section.$_
                Module = (Get-Command $extensions.$section.$_).Module.Name
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4KQF+dXiYqVr21PnJjvO8LEO
# CK+gghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPZVC5LS8aoVonu9h+heRSlV
# QKGTMA0GCSqGSIb3DQEBAQUABIIBABHiz/QnreLnlUuLy0PJsa8B9zHZQuCx+7tK
# /GZADgz2c5jY0JJ8BhoQeB+CfVuuF+PMflCJ1uJAbBDP2OK0qBwXG/mhSy//Xbx8
# hsfkL4W+T0nE3OpwL+U1EWHZ6U2xdaWqIiIgvpCVuU9WlGIOgieSSL6Aol6j5PVr
# OkzIx4J9TfKhC1kOiIgv57+jdFZ3ojxW8/xJ0CZeBZI1Ob/+kv2vVLlliYil7l26
# if+sCfeL8jjMzqGDura0ntmCYi4p7EWGQHrJo3hNmXVRp1VOicB/gDaSFhTFcH3d
# r8wOf9mbHAW6D7AEx2YQo3J2eMrAeMfuCVSdH8JaQczk50ydnBihggILMIICBwYJ
...
# MTgwMjEyMDgzMzUwWjAjBgkqhkiG9w0BCQQxFgQUSq9PoYuIYcN+bAseENw22sg7
# CmwwDQYJKoZIhvcNAQEBBQAEggEAl6NlyNduxWNXOnzPqGOGgFyJ0jqk/KJKcRmQ
# eBRQnALttwRbspTQf1AdAMvXw2YGLm6kwNiJPNsZfLwPnAKTjqqi1kccopx1fFJj
# umhamm4rVPKk93oyHO2LFRjxHfGQxjJ303Rj2gc6TRXzuz5zT1mkNl9Hrl/V1D4/
# nzDylcqChenqd5oA0MejIwRBQdVL0Cc4AAGXhK0treajRwQWk5bvTykoi8XC+XDT
# lTVTEL975DzvvuYR5PecV7CAj838rsgRE8tBDkVaykxAQZUFCPdliti/7LQEYZXF
# qPITt0uoxB9IUhEzolWyTyv/FDqzuj09jAiCSNfmdzx66H7hww==
