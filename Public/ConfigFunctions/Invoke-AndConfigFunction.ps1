function Invoke-AndConfigFunction {
    param(
    ...
    Write-Verbose -Message "Values: $($Values -join ' ')"
    if($Values.Count -lt 2) {
        Write-Error "AND requires two or more values"
        return $false
    }
    $result = $true
    foreach($v in $Values){
        $result = $result -and ($v | SafeTrim)
        if(-not $result) {
            break;
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUKXrMwXV3RD7+vHZ98U3f6ord
# hNygghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCWJhcZk57A3UPweD1Bl+/Vk
# y8yYMA0GCSqGSIb3DQEBAQUABIIBADG443/V4HrXLP9PU12Mhsk2sqEkPE4lqtuY
# eDZiNMZM0QmbSYGuCdR+q+C4/+kyFa+P1Nt+67Tn8dcV26f2OLUoEgJOIj97Kyy1
# ghx5HAwx9EuQoXZ6fDLywnX+HD5ysX/yHq99H2+JryQ1vsdzU10IQUxlHDBLujVH
# /qcQ9GjJFcC+Xf/veqyPcazzF8h5bfk/yr6CsWPZTvFoPJVRn1dB3fgZ+yK8Gs6Q
# qaa1ej2qBXjPMISiWtP1rvsa3EH+v0m5XLC/u9qs/RYJbEkUXCnc4+xlVx4TbyNH
# aVuXa9Twt192QxV/Pe/alDZsWfGEEWK5+bkKFfjRqbpcrikFR6ihggILMIICBwYJ
...
# MTgwMjEyMDgzNDAxWjAjBgkqhkiG9w0BCQQxFgQUq3dMtdjxDq0ZFyynbpTXXtOD
# XWkwDQYJKoZIhvcNAQEBBQAEggEAc6vnbAsDjDEEY/54sBEDc0vlW5RJljEc+iRL
# Vqe9GTcgtWvQB1Zkio8Z6r7irenks9J/WbkiFAlsTf1uswalpeeKBXWK8/L98qzr
# u/oCke0qzNB15BrJ/FBL99Eb5NkKnfRnjxoVIkQi3nfz5nIvCfXj5WRQwPwLLCOe
# 44QOqofj9wKUP0Gb3mWd7/hxRfIxatf3SXslyDgscgjgggSz4KB3pZ9P9IYeccWd
# 0NQurHQ2x8oCbeCVvWXApaRYyv7IjQeNMwHz9v1CDtWO9Z5KexwTNMgbg4Jx9Jr8
# LZynkxISx8WaY5s65kM6tSsmQ1nKogzGKltDLuX0pu+G0fSBdw==
