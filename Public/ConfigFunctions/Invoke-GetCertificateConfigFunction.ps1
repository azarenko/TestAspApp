...
Function Invoke-GetCertificateConfigFunction {
    param(
    ...
    $found = Get-ChildItem -Path $CertStorePath -Recurse | Where-Object {
        # Test as thumbprint
    ...
    if ($found) {
        Write-Verbose -Message "Found Cert with thumbprint: $($found.Thumbprint)"
    }
    else {
        Write-Warning -Message "Could not find Cert: $Id in $CertStorePath"
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUrn1D4lElhH1pJQpjn9RPbNXF
# kWqgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNvGyVdC9yop5ObZ6M/+XZ+5
# eA3DMA0GCSqGSIb3DQEBAQUABIIBAG3SmMGow8RggXhpf84If9Kk+vw8+BYvIrF2
# ruRC2AAKg1ULqvrIgLJoy4nuwmGl6xA18DvU1q/7hnc/eCvJ32bVetQSgg50Bd+w
# EOJ354bkpvWKVeDGMkFwPre03ZPxjLtpNno4BnsAa+TA8/muEe4buYCPrw8Kv5Ks
# 1if6U/vkSb/xr/JwjGj9MPkpVV54iyUH1M67EWuPVXj4Qer+2hD84Z/nF/x9SEU9
# AYeneHuXpbgmCrIH6GESXbDHTsNKUEn16dE+aM46K8zSRJZQmhSqx35rkDIjgsxm
# 2zBQrXn6JIXQwnwzLq1n8nHdhZkQUiQXkAwj0m76z/POK6t6ebKhggILMIICBwYJ
...
# MTgwMjEyMDgzNDA1WjAjBgkqhkiG9w0BCQQxFgQUSqQbl4/ETHDl1lT2DmwCymgP
# 9MgwDQYJKoZIhvcNAQEBBQAEggEAamWhY8lWp9TyjPz3txF+DBhW1UmsQmKUrnDv
# sESHSF/JSBL+5qwZhu/HIqfj9yO3RPnCZ2A2w99VwOjF8qVAKFuGVcpEFtl/yffv
# jwuXMdguhQt6CZNtgXGuee/puwDE0TEzQiX5HQ9R9LTLW0RTIXVqKRSpAPuqRU5d
# dEsu/ECmzJ0bjPzL7mPZ0Mz9dBxglKZliIqyQTlDxxRJuGfFwf/9OFH5gweNzDJ2
# sKaj9hkKKhg5MGXd7c9BpeI+x6J/OUEmVeV+pfhNZs04OyYrfecH3G/uTTxZXlda
# 1jB/2DrTWiNlILKTRaEYthFE9PKVZMeBPvCARkrSSo43LaAi2g==
