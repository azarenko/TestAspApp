...
Function Invoke-ConcatConfigFunction {
    param(
    ...
    if(($null -eq $Values) -or ($Values.Length -eq 0))
    {
        ...
        Write-Verbose "Concatenating: $Values"

        $valueArrayCheck = $Values | ForEach-Object { $_ -is [array] }

        $result = $null
        if(([array]$valueArrayCheck).Contains($true))
        {
            $everything = @()

            $Values | ForEach-Object { $everything = $everything + $_ }

            $result = [array]$everything
        } else {
            $result = $Values -join ''
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUxmGdHBRTUrP51WiFAxUrQ0Wl
# wQKgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDZ5asU7CTcv7LTTzEyyT45D
# w3yyMA0GCSqGSIb3DQEBAQUABIIBACGqPaCc4mIfqfL18D92IEU+6Ys05GLflazy
# KIH8JdN256hqX5k92dvT6i9RPxGhMVgCF5VcHU58xeiRPOMAMltbgWSfSDa0W1ao
# b2FQ7sDhqRrGcq77cOHcSH5Gnq4BIM1rdgNlj0yA9/7QdDms5naEeUalphb8elm4
# G2l4kkEq2voN3GMeMWRSoAPnfdNRVA87on7eWInLLhINvdo4dcnxZFpn3taZRF6P
# DHr2bNXSbUQM/2x5AzKklIfJ/rQ/ZtSvPvRlEMWR1uQnx4EZtjBH+Vlmg3zpBVmq
# L6317m+MX4OnY2ka1YbddXRtq68wk3xXwfHQdd+nzAbW7IxLjDahggILMIICBwYJ
...
# MTgwMjEyMDgzNDAwWjAjBgkqhkiG9w0BCQQxFgQUpjk4PnzXaGZ8caG3oGuaaUSU
# 9d8wDQYJKoZIhvcNAQEBBQAEggEAd873DPDf+jnaCrrTgdflMx8bo1aarOgslDMS
# caDhh9wQX3FtzswF/7yl56VH1AJemDw1bVs3ev9KLFVqRL1R1iPrd0BM3wWtnVey
# I1fUaKE7MgYUoiBFauBeRIiSAuyZvBtnHSPEA6pj8Eb5zAXMO+1BW4FQ5Xha8Fm/
# NHmAi4F7ljtukP/afaC97k7YRbXvG6a0SoUD9bVBmMSogyqbjbQV9/NYp3yXsp2E
# q31YrfkdIDHWFz6ep59QCIDXU4oECuTlcHzT2c76K9KRwHz8uoo8/DV28qllFg2c
# VRUn+H33SxiHeDLqugAet6eyjKa58lwreAvem5aG7aj0kScUuQ==
