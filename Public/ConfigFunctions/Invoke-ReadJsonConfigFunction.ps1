...
Function Invoke-ReadJsonConfigFunction {
    param(
    ...
    (Get-Content $Path).Where({ $_ -notmatch '^\s*\/\/'}) | Out-String | ConvertFrom-Json
}
# SIG # Begin signature block
# MIIXwQYJKoZIhvcNAQcCoIIXsjCCF64CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkqT5m0/IY7dri70uaChKGRxy
# HligghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFC5LCpE1nwMAWrwobHFW1Iq8
# QN7xMA0GCSqGSIb3DQEBAQUABIIBAB0q1r8j47s/oprLvqUACPXQy2COEg8kYjYh
# 2TGeKCA6xoNQa+GxJApZQwBNbogUxgPMIJtWNxmV1+tfBSWzyaNQmBOCI47mQu98
# 5C7KvvQ1Fs/dZ6gD5DBcbrfTzejUo8B5BqsRUUbwv+mXdaRVYpJV4CZpc+pTHMin
# E6rT1+CGtwJkMHW2rowjMnIsHPdqKfYsbNspVO3uYs6rZ2iPo42NBLKezHUr5Ee4
# QLy7ssQrjYSKYyZXRdCTd8fbxCfBPEuiSC/9qnw6pvTh9yvrHxPLO5wwGg/n+8lM
# t8w0vvV8RRh9nF5nbx3PdcK+pOd7e1/DF3cdaLOPVVA7PAbddVOhggILMIICBwYJ
...
# MTgwMjEyMDgzMzUzWjAjBgkqhkiG9w0BCQQxFgQU0f8hC4KNobShFtZ2OoZDKfW8
# pFgwDQYJKoZIhvcNAQEBBQAEggEAPe/GeMmIKqYWWT5THkZ8RoNLej266KzUJ0fW
# q568P0zhIAKuM7kpOyYTNp+2VBQGwTrNQ3JN4p68ExyzJVQDEnezmGnx34HfXC/v
# YoU6Hpda0aUGS9CH5H3Sn63A9meeVKIb+6VnfzciwfMSzYDMu0abFD+igpQQrhIz
# STpsB9v3nDuCywHLus7WMTBe7noLdazdNqB2qy8U1OcRx9CTFVhUcy8pZzbtliHx
# 8sOIqDOX8jgZcr4UIrerhNenhrrQrvTY+ydYFFKDVtgeZj3pM3GECiO+pTQ2TRMy
# 1mV15+rgzBRwfFdYIuPr5O9Nv1lYAwqUG0AEB+E85JCiPpOcOw==
