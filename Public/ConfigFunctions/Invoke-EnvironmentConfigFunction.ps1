...
Function Invoke-EnvironmentConfigFunction {
    param(
    ...
    try {
        ...
        Write-Verbose -Message "Reading environment variable: $Name"
        if($found = Get-Item "env:\$Name" -ErrorAction SilentlyContinue) {
            $result = $found.Value
            Write-Verbose -Message "Result: $result"
            return $result
        } else {
            $message = "Could not find environment variable: $Name"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8GMcPZNRBHZsJi3wi0yU99Si
# HoSgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFF0v0fjLCq5o7J+7Q+xyWxc7
# jEkSMA0GCSqGSIb3DQEBAQUABIIBAD+X9ZPGDRggnKbP0HsyZBPjn345wmNpAMut
# sL7qDdwY99hQHCOdx3mzbChV/3eTglPTOA3/5Of83Xaa7JD3X8g4TMEvVD0RgjcS
# iW7rEk3rtESBQ0QYg5ZzJ+ZPj1PqOT1K9E83M0QehGmFLNPtrJMeBTNBmnDNiPt3
# O9yx9t2x7ryo7qUk5ShuRWPq6RpcNC2OHgGK4H80rKOXbt5al5/EfLlRydMV7sPz
# C90iUaP72Dj/kpP7rxJc3DCPa2tZGPQkQHBIjRGIt61g2hi38wU1zKWGjkGYUdif
# J8nWHj8AIz1w/ExJmw9aQbTR4oBTK+0o6odPPgsr8esRUXcMzVOhggILMIICBwYJ
...
# MTgwMjEyMDgzMzU1WjAjBgkqhkiG9w0BCQQxFgQUfpsoXcBnaVNTuQtjv/pdGKMT
# M3kwDQYJKoZIhvcNAQEBBQAEggEAoOL1pLlFC8ey0tVWLyFI1YRTPeIilgzYzsfF
# ErjoxISM0poqcLEMtPQW3UqFPGJoTH6tl+oFI/wD5CrlNFByA4OlxPnvI7hprWQo
# efACBWuQBX611awMYpX1qDp3+gSnzmuQ2wHHKasiFe2t2K0SOhkLBSsx0DExFyCI
# fSqOAosPqWxsw102FscQ4ZvljfCMsOGfuOY6MPzoGl61WttZs/OofYf5acsz/fC9
# keaMzixJddmTsuEM0+SYBmEO1gTNka1TMr0fsShJJ25eMSwBRlkjbn4h00lrfM4n
# vdQi9I8i9ed2Se0jaiqVH7jKny9mouhPdyozvD1JC7iO26Td4Q==
