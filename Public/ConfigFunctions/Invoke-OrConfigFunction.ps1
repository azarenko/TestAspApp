...
function Invoke-OrConfigFunction {
    param(
    ...
    if($Values.Count -lt 2) {
        Write-Error "OR requires two or more values"
        return $false
    }
    $result = $false
    foreach($v in $Values){
        $result = $result -or ($v | SafeTrim)
        if($result) {
            break;
        }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUshY8iVCj2ZAzx1nsnRHlDMVk
# lYmgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJ8gqSLBs40CS8vMYvobRjbv
# h9s6MA0GCSqGSIb3DQEBAQUABIIBAJnaOD1pySAOycshAnHERgofubh48Fp3Wufo
# fp41KuevOpfpIb5JlcFAWei6aUG1dyZGneALZf4863zVIoniwCs0s6T5uS4k9EYS
# ODXehhpQowtA/wkZ0/Pzdm1LVFue+lhFiqws/MxbL3bLeAzdFviXnNmsLC7vz5He
# 5ezBJIKXzLFgNbrJYT7+8gGCdR/a6Q4r5Feu+gJXaT3wqceOh3TViV/AEyqtGDEO
# eoDFs/XTE92gdAB4MBqpbs0AKfUxh++4Ur714zuGnTbUp9KLCykb5D2qceNeAxmd
# Txgt6ziP3kZlebbGSN/j58HHgrXoZiYpSb2sSJTQQohMpeIPt6KhggILMIICBwYJ
...
# MTgwMjEyMDgzMzU2WjAjBgkqhkiG9w0BCQQxFgQU73980XZOFC5VGmYGJm5LzvEW
# rrwwDQYJKoZIhvcNAQEBBQAEggEAHt6OA3/yFR9i5K76Cneim3Pz8d3qL8L6xpy1
# bzjueMhSoPIvWvYJeOAEqCHz+QQ2aID+W1ytD5aV8IzuakOQoS8CwbG3IJ7C2ZdE
# U2cG3tfKNz7urRLNK8bXPfhcyn+snRsRFkQZMuSo7SRFnd0TX1tDsU8tf3NBIHf0
# GlJ4bisldmUjAOmspc5JvejMRhUnuRAzHOIaUV5ZsIOeniCCg+L2KAGcBMAnfPxQ
# Ai8eimG7XzyBCTTYCOo9ZopNPcpsomutIWNkwVPu2WfpplHxotrwu2l/w0GutfSj
# dBqMeS2mXGqH0h6CrOuewEnN4jri5EpphTsmNuOkYlDjq3iBCw==
