...
Function Invoke-ResolvePathConfigFunction {
    param(
    ...
    $result = (Resolve-Path $Path).ProviderPath
    Write-Verbose "Resolved to: $result"
    return $result
}
# SIG # Begin signature block
# MIIXwQYJKoZIhvcNAQcCoIIXsjCCF64CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtRSpcTz90vtzQA7jeE79teOe
# DmOgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFA2xQ5rCkCan6P/uqM7PHJXr
# m7Q8MA0GCSqGSIb3DQEBAQUABIIBAErSlLkSADZfv0RwMWCtzKgbvlERkf4bSohq
# sSyDR+XZUX1KkmGU08ca/D1fdN4CexvRotnRJnDDi0AsdCDdWW2aeNWu4cV0oQw+
# DppvqKP/C9KKTrKneRq9vc2l3RwSkRWUkXiIkgoEcIG4UnrtfzfjtTxPxnQj3ccv
# hg8Fw20wRB9SEQCEPVQRSx5G37Mvym4dDbW8GhlJ5ZGt75uH9Pigv+BDBh3Jzbru
# lv8h8E/y21v4Ne5Bq2dGZ8MZOg21bQLH+zGNQ/67JQxz04Hw0+ZtuZsIjcrO25e9
# MPIDyaGiCn7dUE0MDWkopAFlItuyjXsGhdM12l7ujDrdxmg6uTShggILMIICBwYJ
...
# MTgwMjEyMDgzMzU4WjAjBgkqhkiG9w0BCQQxFgQUgY1o6/rM26/kq0S1AHfdyrEW
# hnMwDQYJKoZIhvcNAQEBBQAEggEAXaHa284obdclQC1mJ4o4A/6CzDGKAy/IlKle
# I+PN5V2zDSWVJAAWDJFj9BW83Vke7Mql2VqoIAOaQ8rBljXRfghh54Hfdz9CVyFU
# dErBmDyom2DQxgAKSN9p18LO3gfx8Nd2BfkpMnyTrMaEhcu7G0D7F8TdbOP/5PuW
# fPfDOo8Hjz3cytWEHOjhuIEgw+VP+EwHaxxL1HSkqNHZnsgN17ZH/459KTrn5FEi
# 6tS+YV/Erct5KRLnFsCJRceuaFjd9ZcurCIJJjrSDNMH+CAuipmynN01h0TiaJON
# cCPNNCyJelS7nm7LkGlLP9IFCKwBNNW65XSv8aGiiiJziVCAOA==
