...
function Invoke-EqualConfigFunction {
    param(
        [Parameter(Mandatory=$true)]
        [psobject]$LeftOperand,
        [Parameter(Mandatory=$true)]
        [psobject]$RightOperand
    )

    Write-Verbose -Message $PSCmdlet.MyInvocation.MyCommand
    Write-Verbose -Message "Operands: $LeftOperand $RightOperand"
    $result = ($LeftOperand | SafeTrim) -eq ($RightOperand | SafeTrim)
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVCHrIr/2jPIaoS7pvyze+c2w
# 4uCgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPs7719C1otfHhFT9Oni37pp
# O00cMA0GCSqGSIb3DQEBAQUABIIBABWPxxgoIeen2LSYSON/NjWG/tztmbmy/7u1
# cSEnnB+ugApSDtDzoG9n6A8VtD5o2/CN4+/M4OjwBfDcY5AhPGXvIyjUSLjUAJuS
# WVo9WOAU+TYvy/xZ20qgsbvBPwHvqloP938FhE64lN94EoxrICXae16POzktDz7O
# OUJpBYIg/NTvrGxomtJr+5aMfT20lat4SEqJFeW3bhYW+Uc+JyxrPEyLaw8t0sp4
# MLsrbe9XU195LX8zpjCCtcxT5eNVEma/diUOgCMKD6fWp6geq43noc+dpknH9Tu1
# I66k3OapvekAd3apBckQGF1JGsfRk0OwT9uzQD90Rnz18mSM/wShggILMIICBwYJ
...
# MTgwMjEyMDgzMzQ5WjAjBgkqhkiG9w0BCQQxFgQUZ8L0gO1fclCT8NHzHhGLfaVP
# 2u4wDQYJKoZIhvcNAQEBBQAEggEADVuqqUkXoMyfm8zNqzQtPye1cvppkiHQx/ms
# u9nSBAOtgzZcpt1F507oCGQvxxoKY5ZqEwEES+C/7n49wYDsxV7mImr7tKFPARF0
# c3X+nN/OBAv/JqLD3pQNyJlQ566j3C359sE9lML4AzGOBrV/wz8sdWnL7ndxBp5K
# 4ombgpUX5jqKC0Ud4Djxgdn0nszzQaOClDM+PREK/3jR3ES8TJ3uRlEVLmkEjCna
# DS9cv3XkYgj1OLN9WkkYr5D0FMrbjyEaTJ2qmsJ95yBxq1ie3/gR5MV91IKfsX+v
# REPhTLWegdrghpjrF+A4iYPeOSZg9Am3iY9TI0nnWMl7xik57A==
