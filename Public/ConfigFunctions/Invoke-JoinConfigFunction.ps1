...
Function Invoke-JoinConfigFunction {
    ...
    Write-Verbose "Joining: $Values"
    Write-Verbose "Delimiter: $Delimiter"

    $allValues = @()

    $Values | ForEach-Object { $allValues = $allValues + [array]$_ }

    $result = $allValues -join $Delimiter
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4EdUw9bgtjLVOQ496rHaFR5g
# +oKgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFLu6YVS6xdNEoVCdYPT1VFR0
# BSDhMA0GCSqGSIb3DQEBAQUABIIBAIejpzoUavLaif4N9hdh/K9SLo86uw8m7IT/
# ntm6lcIJZJLc0ba+HljdAGSKdg3DMDL9DqeU/0UflN+rTGEZOxYvCoCsIMUjMMj9
# FzoBtnmRSt+f4uB+Glk9Ff9MmXCv3+9CuoALTkL90D9EdkrTOkqmnHjoMxn6uV/8
# qGjiuCSbaAv53H/AiGo3QyfVopmT4LYHjUoja5xWdAursySpU+otqPJPl+UXzJYC
# z4/gW9b9Bj7/m63kO2nyzPLFrO0c3yrjaMxh51onVr1H6n14mcmkiKslbGrcuHcg
# RPWn1SCViJLOwi8/MKqeMoxlRxd6b3H1pAglPcaTO+RdolclQLKhggILMIICBwYJ
...
# MTgwMjEyMDgzMzUwWjAjBgkqhkiG9w0BCQQxFgQUjcXzx/IlUa5mOKPpvijQWUhb
# sKMwDQYJKoZIhvcNAQEBBQAEggEAI6ya6+GhABEUJ6YWlOCj3u73X8cxJwxlcVy4
# Bpv0uIFNNiU42xPVJYJVhKxAo7g3ruB4bdeHOJgeK/qz5EJrupN57+tnmiCG2nSX
# lmDnpkxSxm3iLElR3gMFkPPaj9A7+odiWeFK8V8AZxn43N8u0zr8HHZvi4TWhDlz
# tuIn7mcM4MypVfCV9AQm5o9GWCQmG1ufRzleuL1aeW5R3DIFBiff/rnh45drTjk1
# peI3blBbDistxxXjB0RRHo+9jrFQkETqNJ3iKp5X7lMSzFOMdY8MVee6b+pDRQbp
# riJBg9Z+AzyNdDOJG0+yg87Fs3XSbVHZwATbwnL0KbOkjnHdYQ==
