function AssertModule {
    ...
    if(-not (& $Assert)) {
        $message = "The script '$ScriptName' cannot be run because the following modules that are specified by the `"#requires`" statements of the script are missing: $ModuleName"
        throw [System.Management.Automation.ScriptRequiresException]::new($message)
    }
}

function AssertWebAdministration {
    param(
        [Parameter(Mandatory=$true)]
        [string]$ScriptName
    )

    # Force import - Weirdness with PSDrive
    Import-Module WebAdministration -Force -ErrorAction SilentlyContinue
    AssertModule -ScriptName $ScriptName -Module 'WebAdministration' -Assert { Get-PSDrive -Name 'IIS' -ErrorAction SilentlyContinue }
}
# SIG # Begin signature block
# MIIXwQYJKoZIhvcNAQcCoIIXsjCCF64CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFb6nIQsJlDBassnAhBSrqfdx
# nq6gghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGdsCXfIi05GMLFomiw/9dKH
# MKNbMA0GCSqGSIb3DQEBAQUABIIBAJy+FcNh/2HpxaxlTwWYE4znbl7Ke5HeVq06
# MMj24MKnzPkWbvSQl4MiRyJCoy/Al4wHPXcn8B4Tt/FMWveAblU58egIlloINsgw
# 4sJGiegwTVkgdYbUsRb9sKoraUMCIUw5M9jXuFAkulf8eFhjHumlkoJyd2zG8ayx
# K/EoCshwU45Mcq6eeRTxz1J8XiBefs5zsoxlCUnNzKsjYSrnLZffmjGr3SG/Fn2p
# ub77K+GmSUlIuGAAHNHSBn4uzEAXLBIm+eYfsjrBEkGRBcs21j9hrUTrWVyIy5vj
# rIGKnn8VDWRl+SzFbrmXY8WE7O+UFwhlNWPeI05SAk7nlhvoBzKhggILMIICBwYJ
...
# MTgwMjEyMDgzMzU0WjAjBgkqhkiG9w0BCQQxFgQUicsnk6jmNNhAaE1cZSmRQH7a
# V3QwDQYJKoZIhvcNAQEBBQAEggEAiXMEfg3Ivs4mbfl8/UkmhmtNsk9xgi8cTV+6
# 750fiBDp4SOAqlhJ2O5HZW0qkX1mudLjwYmxAyasLORuQecDA6LRB7TeSwQppJ2z
# bxcA2Z1v8xvAR+VVUeJGq1vRBMrRkoTli0nBMGFEklw9HAs6U3DjmWf+2Mq3JWXT
# QtZcWcJy2aAtzoJnLgEK7VC4R6izdJZzq/mp6oNtWqsfBU57CuJAWDJvN5xTuOOQ
# rnNAd2qpSRRqryL5XehFVdhmi4aC8f1fuukrnmjsGDuxmxx/8Twm3g4apKOGCgsK
# JmFqV3jPOZtUKSiNFe6SUR3rSMjRalnKPiD/FXqSKrYlMCLP2g==
