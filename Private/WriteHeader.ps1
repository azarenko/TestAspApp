...
Function WriteHeader {
    ...
    $versionString = "Version - $($PSCmdlet.MyInvocation.MyCommand.Version.ToString())"
    ...
    $strings.ForEach({ Write-Host -Object $_.PadLeft($mid + ($_.Length/2)) -ForegroundColor Cyan })
    
    $info = [pscustomobject]$settings
    
    Format-List -InputObject $info | Out-Default
}
# SIG # Begin signature block
# MIIXwQYJKoZIhvcNAQcCoIIXsjCCF64CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkA8AS6Ff3roYENa/4EEtpHIP
# oL2gghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFORUnVLRxfGD1Mi+6zT+vR0Z
# XS1wMA0GCSqGSIb3DQEBAQUABIIBAKXwxMon1ub0BGFlvLU4Ge4AqklMJWWMDd3J
# O2XpkhNM7gzxb6tHacOKAGi89VoB3yoBrBiDo8BaXz7K9BVqjCFo0ptNLIFPuO9H
# +nnEs1oyOTVIzuDdgCmG0B2o23XYE+U/FFyYIFrXppZXUv4y64WMkGujNTX2j/Oe
# AeeVSwXR7n36oMtFnPNCy2Q841roYJ8oF3/yO1qk2Lg12yCNwmmIXKYlEr+jrWAV
# Y7YrUxSoYviaPI33A0P97hjY2SWD0+TV4HE8VtC4d8zdwMr4Q9Eix0utq5bDT3Ak
# XGQyknkHXrLqVhGcfhqcOWvFkCUquRBNCxEzrSeOkARBbS2VhBOhggILMIICBwYJ
...
# MTgwMjEyMDgzNDA1WjAjBgkqhkiG9w0BCQQxFgQUE1snTMjwIyXMZ9xM6u3E+Xuc
# eJYwDQYJKoZIhvcNAQEBBQAEggEATzM3vH24HXEtYEa01SqQVTX0T4CVg36xoaax
# dt5PQpY6wDrKeUxtFzor8tC4Pj16sDTWwuqkXwPp9gg3cmSKxd9hd3KYyCTiKeeY
# X/9kBmgC9Meui/iC9tBVyiBnuiCaFj/6uF+eOLHmpH3XXwcNvGsO4RpG2/8wRn/S
# Jsk9aozxqvO0evgxx29nteihvt4XzaPtGzTuPR8NEDWkD+035Ko/XJIpvL6nzOBc
# LAd8OAaCjg35y66rzrP7uZQQ8dwWovkO2nnE61+RX01Rb6gbsGJcLiovBACyqUpv
# XAh+m4/iExi9n3eK8APRMulEzDEtUsvtEk2yqDfS0uXB/o8uew==
