...
function RegisterDefaultExtensions {
    ...
    # Explicit registration for Import-Certificate used by SitecoreFundamentals
    RegisterExtension -Command Import-Certificate -As ImportCertificate -Type Task

	# Also register the commands from SitecoreFundamentals
    Get-Command -Module SitecoreFundamentals | ForEach-Object {
        RegisterExtension -Command $_.Name -As ($_.Name.Replace('-','')) -Type Task
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUBRpRvxdqn2FGSPje9VumjTlv
# 6DGgghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMDMbfV9vAHOlcKm4TlIsbqx
# N1uxMA0GCSqGSIb3DQEBAQUABIIBABda+5Wfy1SDXinuo7qqPh24F1SjOtKOPKsh
# Qy3QOd9CdiGkuL2TU6tDIyk0MHFZDG9F7c/5bw+AYfnzhhObpsiHtFYAtv2qN97R
# vJdLd/3ZACXoy+Li/Mnj5o4OeUn33sm9+s91sijq9RLFoEprxQguL8dP6X9ZC28V
# 0KdUlzCOEjITqm5nXydKM9gwcJpWd3vUB8hiXKgD+IBj7PsIznbr9vvNyUj+FBs7
# gbm4lH6cxKZI9kWyUn/Zedowf3IkDQx4AC+s+FErdSdlnhxADqMpRdlbO4Xudkvn
# YnLhEMf0dlguhXC7JAa2VYet4paEhXIPWJtoLZ/bvA+oAh4svJKhggILMIICBwYJ
...
# MTgwMjEyMDgzMzU0WjAjBgkqhkiG9w0BCQQxFgQUIB/7aYciB3XnOZqjIwsvLwOA
# 4GcwDQYJKoZIhvcNAQEBBQAEggEACLdnKIiTcUVXGtqEnx7cMEpdCPuxGHu4Fi/2
# 3fX7uJu5Yciw1NVrPvtGplpB6rpZhFivGLd/5xoWzeM8RqwbC7TEqmND0dZtZgAv
# +LOBLu7Qc7JGuuyFGCHbWT+3zqdL4SwGdpPf2Xq2IKl1lu4AsZuDpkhghSJqMMnP
# B12nSKP8G7rDZKdO3MM86/3NyyevNT11dNTJJ7u9mNppcfCscL2osRA7W4uZBpdJ
# JDIFom5aH1VtU4U1sQIfNtazgVxdxwc+fNd2Tv+uLeFUitegoCu5zMB5tLn6jUXX
# Fuqk8Iacg+4o2kYxdif6kAMW6Wu4QXxqORBCtkxnZJTd9FVG7Q==
